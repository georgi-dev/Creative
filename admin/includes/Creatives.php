...
//Debug::var_debug(CONTENT_SUBPAGE);
    ...
    creative
        (
            ...
            creative_products_link_author,
            creative_products_cat,
            creative_products_link_cat,
            creative_products_sub_cat,
            creative_products_link_sub_cat,
        ...
        (
            ...
            :field_products_name,
            :field_products_author,
            :field_products_link_author,
            :field_products_cat,
            :field_products_link_cat,
            :field_products_sub_cat,
            :field_products_link_sub_cat,
            :field_products_desc,
            :field_images,
            :field_created
        )
        ');
        $rst->execute(array("
            :field_products_name" => $params["field_products_name"],
            ":field_products_author" => $params["field_products_author"],
            ":field_products_link_author" => $params["field_products_link_author"],
            ":field_products_cat" => $params["field_products_cat"],
            ":field_products_link_cat" => $params["field_products_link_cat"],
            ":field_products_sub_cat" => $params["field_products_sub_cat"],
            ":field_products_link_sub_cat" => $params["field_products_link_sub_cat"],
            ":field_products_desc" => $params["field_products_desc"],
            ":field_images" => $params["field_images"],
            ":field_created" => $params["field_created"]
        ));
    ...
    {Debug::var_debug($params);
        ...
        $rst = $pdo->prepare('
            ...
            creative 
            SET
                creative_products_name=:field_products_name,

                creative_products_author=:field_products_author,

                creative_products_link_author=:field_products_link_author,

                creative_products_cat=:field_products_cat,

                creative_products_link_cat=:field_products_link_cat,

                creative_products_sub_cat=:field_products_sub_cat,

                creative_products_link_sub_cat=:field_products_link_sub_cat,

                creative_products_desc=:field_products_desc,

                creative_images=:field_images,

                creative_created=:field_created
            WHERE 
    ...
    public function remove($params)
    {
        ...
        $rst = $pdo->prepare('
            ...
            creative 
            WHERE 
            creative_id=:field_id
        ');
        $rst->execute(array(":field_id" => $params["field_id"]));
