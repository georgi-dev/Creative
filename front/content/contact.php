		<main>
			...
			<section id="hero" class="light-bg img-bg img-bg-softer" style="background-image: url(assets/images/art/image-background04.jpg);">
				<div class="container inner">
					<div class="row">
						<div class="col-md-8">
							<header>
								<h1>Get in touch</h1>
								<p>Have an idea? Have a suggestion? Drop us a line!</p>
							</header>
						</div><!-- /.col -->
					</div><!-- ./row -->
				</div><!-- /.container -->
			...
			<div class="container inner">
				<div class="row">
						...
						<div class="row">
							...
							<h2>Contacts</h2>
							<p>We are opened for partnerships, ideas, suggestions, collaboration and other mastermind pieces!</p>
							</div><!-- /.col -->

							<div class="col-sm-6">
								<h3>New Web World Ltd.</h3>
								<ul class="contacts">
					...
					<div class="col-md-6 inner-right-md">
								...
								<div class="col-sm-6 thumb">
									<figure class="member">
										...
										<figcaption class="member-details bordered no-top-border">
											<h3>
												Georgi Ivanov
												<span>Senior Developer & SEO</span>
											</h3>
										</figcaption>
